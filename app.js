...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      'contact-addr-body': 'Opp. Maulana Azad Inter College, Mehdawal Road, Khalilabad, Uttar Pradesh – 272175',
      ...
      'footer-address': 'Opp. Maulana Azad Inter College, Mehdawal Road, Khalilabad, UP',
    ...
    hi: {
      ...
      'contact-addr-body': 'मौलाना आजाद इंटर कॉलेज के सामने, मेहदावल रोड, खलीलाबाद, उत्तर प्रदेश – 272175',
      ...
      'footer-address': 'मौलाना आजाद इंटर कॉलेज के सामने, मेहदावल रोड, खलीलाबाद, यूपी',
